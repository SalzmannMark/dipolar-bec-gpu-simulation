...
struct Algo { int num_initial_graddesc_steps{}, num_realtime_steps{}, write_output_every{}; double residual{}, alpha{}, beta{}, time_step{};};
...
public:
    ...
    void import_parameters_with_omega_database();
    ...
    std::vector<OmegaDatabase> load_trap_parameters(const std::string& filename);
};
